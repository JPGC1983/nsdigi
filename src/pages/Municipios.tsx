...
import { Search, MapPin, Users, TrendingUp, Filter, Plus } from "lucide-react";
...
const municipalities: Municipality[] = [
  ...
  },
  {
    ...
    coordinator: "Dra. Ana Paula Santos",
  },
  {
    id: "3",
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="rounded-lg border border-success/20 bg-success/5 p-4">
            ...
            <p className="text-2xl font-bold text-success">
              {municipalities.filter((m) => m.status === "ativo").length}
            </p>
          </div>
          <div className="rounded-lg border border-warning/20 bg-warning/5 p-4">
            <p className="text-sm text-muted-foreground">Em Implantação</p>
            <p className="text-2xl font-bold text-warning">
              {municipalities.filter((m) => m.status === "em_implantacao").length}
            </p>
          </div>
          <div className="rounded-lg border border-border bg-card p-4">
